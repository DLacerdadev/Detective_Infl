...
import { classesTable, origensTable, periciasTable, trilhasTable, rituaisTable, habilidadesTable } from "./schema/game";
...
async function seedHabilidades() {
  ...
  const rows = [
    { id: "d9b561ba-a784-4215-804d-ea18ccac8ac7", nome: "Ataque Especial", categoria: "HABILIDADE_CLASSE", classe: "COMBATENTE", descricao: "Gasta 2 PE para obter +5 em um teste de ataque ou +5 no dano. A cada PE adicional gasto acima de 2, aumenta o bônus em +5. No NEX 25% pode gastar até 3 PE, no NEX 55% até 4 PE e no NEX 85% até 5 PE.", fonte: "LIVRO_BASE", alterada: false, nex: 5 },
    { id: "5a52d3cd-58a4-4652-aaf0-87c9aa1ad00e", nome: "Perito", categoria: "HABILIDADE_CLASSE", classe: "ESPECIALISTA", descricao: "Escolha duas perícias. Gasta 2 PE para adicionar +1d6 em um teste dessas perícias. No NEX 25% aumenta para +1d8, no 55% para +1d10 e no 85% para +1d12.", fonte: "LIVRO_BASE", alterada: false, nex: 5 },
    { id: "b540ac7e-4c98-49a5-a375-c0a4b4b64740", nome: "Eclético", categoria: "HABILIDADE_CLASSE", classe: "ESPECIALISTA", descricao: "Gasta 2 PE para ser considerado treinado em uma perícia não treinada até o fim da cena.", fonte: "LIVRO_BASE", alterada: false, nex: 5 },
    { id: "9a9d1587-8cd0-4a76-aaa9-c65d990a66a6", nome: "Escolhido pelo Outro Lado", categoria: "HABILIDADE_CLASSE", classe: "OCULTISTA", descricao: "Começa com 3 rituais de 1º círculo. No NEX 25% ganha acesso ao 2º círculo, no 55% ao 3º e no 85% ao 4º.", fonte: "LIVRO_BASE", alterada: false, nex: 5 },
    { id: "7f249b6e-9168-44c3-90b2-b07e15ae433b", nome: "Artista Marcial", categoria: "PODER_GERAL", classe: "GERAL", descricao: "Você não precisa de armas para lutar. Seus ataques desarmados causam 1d6 de dano de impacto e são considerados ataques com arma simples. Além disso, você pode usar Luta para se defender em combate.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "c5372bce-e0b1-491c-af4f-1efe3d570418", nome: "Combater com Duas Armas", categoria: "PODER_GERAL", classe: "GERAL", descricao: "Quando usa uma arma leve na mão principal e outra arma leve na mão secundária, pode fazer um ataque extra com a arma secundária como ação livre (uma vez por rodada). Esse ataque extra sofre –2 no teste de ataque.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "ccbcf35a-2373-4566-aeda-22ff06c1a479", nome: "Combate Defensivo", categoria: "PODER_GERAL", classe: "GERAL", descricao: "Ao realizar um ataque, você pode optar por reduzir o bônus de ataque em até –5 para receber o mesmo valor como bônus na Defesa até o início do seu próximo turno.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "4a284932-0aac-4d86-8632-df79d5affd17", nome: "Escudo Veloz", categoria: "PODER_GERAL", classe: "GERAL", descricao: "Ao ser atingido por um ataque, como reação, você pode gastar 1 PE para adicionar +5 na sua Defesa contra aquele ataque.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "e2e2ed2d-3cd4-4ea8-8ad1-b88c2db13a42", nome: "Mestre em Arma", categoria: "PODER_GERAL", classe: "GERAL", descricao: "Escolha uma arma. Você recebe +2 em testes de ataque e +2 no dano com essa arma. Você pode escolher este poder mais de uma vez, cada vez para uma arma diferente.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "72b4688f-68d7-4e62-887b-7646bc348e54", nome: "Saque Rápido", categoria: "PODER_GERAL", classe: "GERAL", descricao: "Sacar ou guardar uma arma é uma ação livre para você (em vez de ação rápida). Além disso, você não sofre penalidade por realizar essa ação durante um movimento.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "2eae88b0-903e-493c-8e0e-189b2adbd132", nome: "Tiro de Cobertura", categoria: "PODER_GERAL", classe: "GERAL", descricao: "Você pode gastar 2 PE para forçar um inimigo em alcance curto a se proteger. O alvo deve fazer um teste de Reflexos (DT 15). Se falhar, sofre –5 em testes de ataque até o início do seu próximo turno.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "6704692e-bb8e-4597-acec-8acfc04d3109", nome: "Amigo dos Animais", categoria: "ORIGEM", classe: "GERAL", descricao: "Seu vínculo com animais vai além do comum. Você recebe +5 em testes de Adestramento, e animais não agressivos nunca atacam você. Você pode tentar treinar qualquer animal, mesmo os selvagens.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "404ba403-8a7f-4431-82b8-369ce130b919", nome: "Cientista", categoria: "ORIGEM", classe: "GERAL", descricao: "Seu rigor científico é excepcional. Uma vez por cena, quando faz um teste de Ciências ou Tecnologia, você pode optar por não rolar o dado: o resultado é automaticamente 10 + seu bônus total.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "f7846aac-b571-47e7-8458-ee41a886779e", nome: "Colegial", categoria: "ORIGEM", classe: "GERAL", descricao: "Você ainda vive o mundo escolar. Recebe +2 em todos os testes de perícias ligadas a conhecimento (Ciências, História, Ocultismo, Religião). Além disso, uma vez por cena pode pedir ajuda a um contato escolar para obter uma informação.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "ce96c084-bc0d-46d7-a12a-6fd49a8d565b", nome: "Cozinheiro", categoria: "ORIGEM", classe: "GERAL", descricao: "Você sabe preparar comida que restaura energias. Uma vez por descanso longo, pode preparar uma refeição para até 6 personagens. Cada um recupera 1 nível de fadiga e recebe +5 PV temporários até o próximo descanso.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "275114da-13e6-4c62-9082-ae4982c54431", nome: "Dublê", categoria: "ORIGEM", classe: "GERAL", descricao: "Você é treinado para realizar cenas de ação arriscadas. Recebe +5 em testes de Acrobacia e Atletismo, e reduz em 1 dado qualquer queda (ex.: 3d6 vira 2d6). Pode usar Atletismo no lugar de Reflexos para esquivar de explosões.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "daeb596b-e4a8-4855-9f67-a6328cb0e80c", nome: "Experimento", categoria: "ORIGEM", classe: "GERAL", descricao: "Você foi submetido a experimentos que alteraram sua biologia. Escolha: (a) +1 em Vigor; (b) RD 2 contra um tipo de dano de sua escolha; (c) visão no escuro em alcance curto. Você sofre –2 em testes de Presença com pessoas que percebem algo errado em você.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "2969a014-9d54-4326-b6a3-f69e40b2abda", nome: "Fazendeiro", categoria: "ORIGEM", classe: "GERAL", descricao: "Criado no campo, você conhece o trabalho duro e a sobrevivência. Recebe +5 em Sobrevivência e pode usar Sobrevivência para primeiros socorros. Uma vez por cena, ao realizar trabalho físico prolongado, pode ignorar um nível de fadiga.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "0650d8df-0957-428f-afa9-8301f36fdd4a", nome: "Herdeiro", categoria: "ORIGEM", classe: "GERAL", descricao: "Você vem de família abastada. Recebe +5 em testes de Diplomacia e Enganação com pessoas de alta sociedade. Uma vez por aventura, pode usar sua influência para obter um favor de um contato de alto status.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "ce2213d5-f4cd-4042-a058-d3604b89d9c0", nome: "Mergulhador", categoria: "ORIGEM", classe: "GERAL", descricao: "Você é adaptado ao ambiente aquático. Pode prender a respiração por 2 minutos + Vigor minutos. Recebe +5 em testes de Atletismo para nadar e não sofre penalidade de movimento na água.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "4f413691-01ce-4f6d-b10f-b06f3e2dbb07", nome: "Político", categoria: "ORIGEM", classe: "GERAL", descricao: "Você navega pelos corredores do poder com habilidade. Recebe +5 em Diplomacia e Enganação. Uma vez por cena, pode usar sua influência para obter informações privilegiadas ou um favor de uma figura de autoridade local.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "a5650113-dc33-42cc-8bbd-8d40998c8fcd", nome: "Apego Angustiado", categoria: "PODER_CLASSE", classe: "COMBATENTE", descricao: "Quando um aliado ao seu alcance imediato fica incapacitado, você pode gastar 1 PE como reação para realizar imediatamente um ataque contra o responsável.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "f77b85fa-a3ae-4af4-8489-f0be4816ad4e", nome: "Caminho para Forca", categoria: "PODER_CLASSE", classe: "COMBATENTE", descricao: "Ao reduzir um inimigo a 0 PV, você recupera PE igual ao bônus de Vigor (mínimo 1). Pode usar uma vez por rodada.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "50fd0f7b-2b68-43ba-b5c6-72f33ab6e00c", nome: "Ciente das Cicatrizes", categoria: "PODER_CLASSE", classe: "COMBATENTE", descricao: "Você não cai inconsciente ao atingir 0 PV; pode continuar agindo, mas recebe 1d6 de dano de Morte por rodada. Você cai morto apenas ao atingir PV negativos iguais ao seu Vigor.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "2f2b745e-2e94-4779-baa4-d67e7f9ad894", nome: "Correria Desesperada", categoria: "PODER_CLASSE", classe: "COMBATENTE", descricao: "Ao gastar 2 PE, você pode se mover o dobro do seu deslocamento como ação padrão. Durante esse movimento, você ignora terreno difícil e pode passar pelo espaço de inimigos.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "d9bdfd4d-d4b8-4057-ad42-caf2d27637b5", nome: "Engolir o Choro", categoria: "PODER_CLASSE", classe: "COMBATENTE", descricao: "Uma vez por cena, ao falhar em um teste de Vontade, você pode gastar 2 PE para tratar o resultado como 10 + seu bônus de Vontade.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "27b2b72f-d612-4ab8-bedd-dbae7c6d59e2", nome: "Instinto de Fuga", categoria: "PODER_CLASSE", classe: "COMBATENTE", descricao: "Você tem instinto aguçado para o perigo. No início de cada cena, você não pode ser surpreendido. Além disso, pode gastar 1 PE como reação para mover-se até a metade do seu deslocamento sem provocar ataques de oportunidade.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "3acb2e82-b790-4d6d-9ae7-db5627e97c5e", nome: "Mochileiro", categoria: "PODER_CLASSE", classe: "COMBATENTE", descricao: "Você está acostumado a carregar cargas pesadas sem perder agilidade. O limite de peso para carga média e pesada dobra para você, e você não sofre penalidade em Furtividade por usar armadura leve.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "24ec1fc3-e809-41b7-a50c-385e09150273", nome: "Paranoia Defensiva", categoria: "PODER_CLASSE", classe: "COMBATENTE", descricao: "Você está sempre em alerta máximo. Recebe +2 em Defesa contra ataques de criaturas que você não tinha visto antes do combate começar. Além disso, nunca é considerado desprevenido no primeiro turno de combate.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "6a26bd77-865d-4f2c-82c6-201c89177848", nome: "Sacrificar os Joelhos", categoria: "PODER_CLASSE", classe: "COMBATENTE", descricao: "Ao cair de uma altura, você pode gastar 1 PE para reduzir o dano à metade e não ficar caído. Além disso, ao ser derrubado por um efeito, pode gastar 1 PE como reação para permanecer em pé.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "37413ee1-4646-4282-8e8a-7e3215115dad", nome: "Sem Tempo, Irmão", categoria: "PODER_CLASSE", classe: "COMBATENTE", descricao: "Você age com velocidade excepcional em momentos críticos. Uma vez por cena, pode realizar uma ação de movimento como ação livre.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "e2083589-21c2-4097-b57c-64ef74c5b41f", nome: "Valentão", categoria: "PODER_CLASSE", classe: "COMBATENTE", descricao: "Ao intimidar um inimigo com sucesso usando Intimidação, ele fica abalado por 1 rodada extra. Além disso, enquanto o alvo estiver abalado, seus ataques contra ele causam +1d6 de dano.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "d8c15636-c214-4819-90c2-01520dbfe61c", nome: "Alerta de Perigo", categoria: "PODER_CLASSE", classe: "ESPECIALISTA", descricao: "Você percebe ameaças antes dos outros. Recebe +5 em testes de Percepção para detectar emboscadas, e sempre age na surpresa mesmo que não perceba os inimigos.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "f9c23798-918b-45a8-bc24-8854ed3229b4", nome: "Analista de Campo", categoria: "PODER_CLASSE", classe: "ESPECIALISTA", descricao: "Ao observar um inimigo por uma ação padrão, você identifica pontos fracos. Seus ataques contra esse alvo ignoram RD igual ao seu bônus de Intelecto até o fim da cena.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "92a16ab5-35a4-4632-8f66-933b6e81b98c", nome: "Autossuficiente", categoria: "PODER_CLASSE", classe: "ESPECIALISTA", descricao: "Você sabe se virar em qualquer situação. Recebe +2 em todos os testes de perícias não treinadas, e pode usar Sobrevivência para criar um acampamento improvisado que concede os mesmos benefícios de um descanso em local seguro.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "f0a04f15-3f24-4d85-be97-f5559d5d3ba1", nome: "Deduzir", categoria: "PODER_CLASSE", classe: "ESPECIALISTA", descricao: "Uma vez por cena, ao analisar uma situação, local ou criatura, você pode fazer um teste de Investigação (DT à critério do mestre) para deduzir automaticamente uma informação útil sem precisar de pistas adicionais.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "6393d6b9-b259-4dd9-b5bf-aec4d8808e8f", nome: "Improvisador", categoria: "PODER_CLASSE", classe: "ESPECIALISTA", descricao: "Você é mestre em criar soluções com o que tem à mão. Uma vez por cena, pode criar um gadget improvisado com materiais disponíveis. O gadget tem um efeito simples à sua escolha e dura até o fim da cena.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "bd829cc3-b90d-473f-aa22-de1bfb3ff202", nome: "Ligeiro", categoria: "PODER_CLASSE", classe: "ESPECIALISTA", descricao: "Seu deslocamento aumenta em 3m. Além disso, você pode usar a ação de movimento para se mover e ainda realizar uma ação livre de interação (sacar item, abrir porta, pegar objeto).", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "798e57df-b239-4158-9b2a-244de7df5613", nome: "Planejamento Estratégico", categoria: "PODER_CLASSE", classe: "ESPECIALISTA", descricao: "No início de uma cena de combate, você pode gastar 1 PE para criar um plano. Escolha um aliado: ele recebe +2 em todos os testes até o fim da cena. Você pode incluir mais aliados gastando 1 PE adicional por aliado.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "64c34f96-81f6-4e4e-8d3b-3bab3fd58eb8", nome: "Conexão Paranormal", categoria: "PODER_CLASSE", classe: "OCULTISTA", descricao: "Você sente o Outro Lado mais profundamente. Recebe +5 em testes de Ocultismo e pode detectar automaticamente a presença de paranormal em alcance curto ao gastar 1 PE.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "c73c7549-5c25-4e9a-8fb8-93e8625cf85e", nome: "Estudo Intensivo", categoria: "PODER_CLASSE", classe: "OCULTISTA", descricao: "Você pode aprender rituais adicionais com mais facilidade. O custo em tempo e recursos para aprender um novo ritual é reduzido à metade. Além disso, você pode aprender rituais de um círculo acima do máximo permitido pelo seu NEX.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "19944ecc-a93a-4dae-a0ed-b0255c478e18", nome: "Mente Aberta", categoria: "PODER_CLASSE", classe: "OCULTISTA", descricao: "Sua mente está adaptada às verdades do Outro Lado. Recebe +5 em testes de Vontade contra efeitos paranormais, e quando sofrer dano de Sanidade, pode gastar 2 PE para reduzir esse dano à metade.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "cf1ec786-edfe-4790-aefb-a5e4e0534b1f", nome: "Ritualista Veloz", categoria: "PODER_CLASSE", classe: "OCULTISTA", descricao: "Você pode executar rituais com mais agilidade. Rituais com execução Padrão podem ser executados como ação rápida gastando 2 PE adicionais. Rituais com execução Completa podem ser executados como ação padrão gastando 2 PE adicionais.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "9b0b02a3-0c84-4cae-ad05-064801b1c3a2", nome: "Sensitivo", categoria: "PODER_CLASSE", classe: "OCULTISTA", descricao: "Você percebe emanações paranormais passivamente. Sempre que entrar em uma área com atividade paranormal significativa, o mestre deve informar você discretamente. Além disso, recebe +5 em testes de Ocultismo para identificar rituais e entidades.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "7ca9f04a-7019-4413-a6eb-a96545d398df", nome: "Agente do Governo", categoria: "TRILHA", classe: "ESPECIALISTA", descricao: "Trilha de Especialista do suplemento Sobrevivendo ao Horror. Você tem autoridade e recursos estatais. Recebe acesso a documentos, contatos e equipamentos governamentais. Uma vez por aventura pode acionar recursos institucionais.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "89b343f2-26d0-4240-8822-7ddb5c04a57f", nome: "Monstruoso", categoria: "TRILHA", classe: "COMBATENTE", descricao: "Trilha de Combatente do suplemento Sobrevivendo ao Horror. Você manifesta características físicas paranormais: garras (1d6 corte), mordida (1d6 perfuração) e +2 em Fortitude. Sua aparência assustadora concede +5 em Intimidação.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "34cbd92d-262c-490a-9132-f0e8ff5dfc98", nome: "Flagelador", categoria: "TRILHA", classe: "OCULTISTA", descricao: "Trilha de Ocultista do suplemento Sobrevivendo ao Horror. Você usa PV em vez de PE para executar rituais (custo em PV = custo em PE). Quando usa PV assim, os rituais têm seus efeitos potencializados (+1 círculo de efeito).", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "8aeb9a6b-e087-460b-8406-2d95addee5c3", nome: "Sobrevivente", categoria: "TRILHA", classe: "SOBREVIVENTE", descricao: "Trilha de Sobrevivente do suplemento Sobrevivendo ao Horror. Você aprimorou instintos básicos de sobrevivência. Recebe bônus progressivos conforme avança: Empenho (nível 1), Habilidade de Trilha (nível 2), Aumento de Atributo (nível 3).", fonte: "SOBREVIVENDO_AO_HORROR", alterada: false, nex: null },
    { id: "a3b2ce1b-0bb4-4297-80cf-81aea2619b19", nome: "Infiltrador", categoria: "TRILHA", classe: "ESPECIALISTA", descricao: "ALTERADO (Sobrevivendo ao Horror): Agora interage com a mecânica de Visibilidade. Seus ataques furtivos causam dano adicional contra alvos que não percebem você. Em condições de baixa visibilidade, recebe +5 em Furtividade e seu dano furtivo aumenta em +1d6.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: true, nex: null },
    { id: "bba04be6-5819-4f8b-bc2a-52cadef77ad5", nome: "Atirador de Elite", categoria: "TRILHA", classe: "ESPECIALISTA", descricao: "ALTERADO (Sobrevivendo ao Horror): Ajustes na precisão e bônus de dano. Ataques à distância recebem +2 no teste. Em alcance longo, você não sofre penalidade. Com uma rodada de preparação (ação completa), seu próximo ataque causa +2d6 de dano.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: true, nex: null },
    { id: "3c370bb1-144e-43d4-8601-5e408cd615c8", nome: "Guerreiro", categoria: "TRILHA", classe: "COMBATENTE", descricao: "ALTERADO (Sobrevivendo ao Horror): Ajustes em manobras de combate. Você pode realizar manobras (Agarrar, Desarmar, Derrubar, Empurrar) como ação rápida. Manobras bem-sucedidas concedem +2 em seu próximo ataque contra o mesmo alvo.", fonte: "SOBREVIVENDO_AO_HORROR", alterada: true, nex: null },
  ];
  await db.insert(habilidadesTable).values(rows);
  console.log(`==> ${rows.length} habilidades seeded.`);
}
...
async function seed() {
  ...
  const [{ value: habilidadesCount }] = await db.select({ value: count() }).from(habilidadesTable);

  if (Number(classCount) > 0 && Number(rituaisCount) > 0 && Number(habilidadesCount) > 0) {
